...
function MusicPlayer() {
  return (
    <div
      className="musicPlayer flex flex-col px-5 border-2 w-[100%] border-black py-3 rounded-xl mt-5
    bg-[#232a4e]"
    >
      <div className="upperPart flex items-center justify-between">
        <div className="profile flex">
          ...
          <div className="details flex flex-col ml-4">
            <span className="text-[1rem]">Dolor nulla dolores</span>
      ...
      <div className="lowerPart flex items-center justify-between mt-5">
        <div className="track flex justify-between text-sm text-gray-500 flex-[2] items-center">
          ...
          <img
            ...
            className="w-[16rem]"
          />
          <span className="">4: 30</span>
        </div>
        <div className="controls flex items-center flex-1 justify-around">
